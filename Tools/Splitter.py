...
class ExcelSplitterApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Excel Splitter Full")
...
for i in range(jumlah_file):
    ...
    df_chunk = df.iloc[start_idx:end_idx]
                output_file = os.path.join(output_dir, f'Report_detail_{i+1}.xlsx')
